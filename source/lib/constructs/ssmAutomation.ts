...
export class SSMAutomation extends Construct {
    public constructor(scope: Construct, id: string, props: SSMAutomationProps) {
        ...
        addCfnGuardSuppression(ssmAutomationRole, [
            {
    ...
    private createEventAutomationStartRole(
        ...
        const eventAutomationStartRole = new iam.Role(
            this,
            `${serviceName}EventAutomationStartRole`,
            {
        ...
        addCfnGuardSuppression(eventAutomationStartRole, [
            {
                id: 'IAM_NO_INLINE_POLICY_CHECK',
                reason: 'We require the related permissions.',
            },
        ]);
        return eventAutomationStartRole;
    }
