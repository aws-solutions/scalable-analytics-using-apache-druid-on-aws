 ...
 */
@Path(BasicHTTPCallbackResource.SELF_URL)
@LazySingleton
public class BasicHTTPCallbackResource {
    public static final String SELF_URL = "/druid-ext/druid-x-basic-auth/callback";

    private static final Logger LOGGER = new Logger(BasicHTTPCallbackResource.class);

    @Inject
    public BasicHTTPCallbackResource() {
        // do nothing
    }
